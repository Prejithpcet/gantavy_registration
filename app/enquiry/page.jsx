  ...
  return (
    <>
      <section
        ...
        style={{ backgroundImage: 'url("/page2.png")' }}
      >
        <div className="w-[820px] h-fit sm:h-[550px] shadow-xl bg-white rounded-3xl backdrop-blur-sm bg-white/20 flex flex-col items-center relative">
          {" "}
          ...
          <div className="relative pt-10 w-full sm:flex pl-8 sm:pl-0">
            <a href="#" className="sm:absolute sm:left-1/2 sm:-translate-x-1/2">
              <button className="flex gap-2 px-3 py-1 rounded-2xl transition hover:backdrop-blur-sm hover:bg-white/40">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-white font-light text-xs">
                    Register with our portal and find courses
                  </span>
                  <span className="text-white font-light text-xs">
                    as low as 5000 CAD / year in Canada.
                  </span>
                </div>
              </button>
            </a>
            <a href="#" className="sm:absolute sm:left-16 sm:top-32">
              <button className="flex gap-2 px-3 py-1 rounded-2xl transition hover:backdrop-blur-sm hover:bg-white/40">
                <Image
                  src="/Icon2.svg"
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-white font-light text-xs">
                    For investments over 200k $ our fee
                  </span>
                  <span className="text-white font-light text-xs">
                    is after visa. Visit to see more from
                  </span>
                  <span className="text-white font-light text-xs">Gantavy</span>
                </div>
              </button>
            </a>
            <a href="#" className="sm:absolute sm:right-16 sm:top-32">
              <button className="flex gap-2 px-3 py-1 rounded-2xl transition hover:backdrop-blur-sm hover:bg-white/40">
                <Image
                  src="/Icon3.svg"
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-white font-light text-xs">
                    We are bound to get you visa, get a
                  </span>
                  <span className="text-white font-light text-xs">
                    free consultation to find out a
                  </span>
                  <span className="text-white font-light text-xs">
                    workable solution for your profile.
                  </span>
                </div>
              </button>
            </a>
